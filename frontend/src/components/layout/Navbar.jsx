      ...
      <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <Link to="/shop" className="flex items-center gap-2 group">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-[10px] text-zinc-400 -mt-0.5 tracking-wide uppercase font-medium">Mutual Fund EMIs</span>
          </div>
        </Link>

        {/* Desktop Navigation */}
        <nav className="hidden md:flex items-center gap-1 bg-[#F5F3FF] p-1 rounded-pill border border-[#E4E4E7]/60">
          {navLinks.map((link) => {
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            to="/shop"
            className="flex items-center justify-center w-9 h-9 rounded-full bg-zinc-100 hover:bg-zinc-200 text-zinc-700 transition-colors"
            title="Browse Shop"
          >
